...
unsigned char sdata=0,rx[40],r; const 
int trigPin1 = A0; const int echoPin1 
= A1; int 
us1,tl,mot=A3,buz=13,fir=A2,k='1'; 
void setup() 
{ 
 Serial.begin(9600); 
pinMode(mot,OUTPUT); 
pinMode(buz,OUTPUT); 
pinMode(fir,INPUT); lcd.begin(16, 
2); 
 // Print a message to the LCD. 
lcd.setCursor(0, 0); lcd.print("WATER 
LEVEL CTRL"); lcd.setCursor(0, 1); 
lcd.print(" SYSTEM "); 
 
 //delay(2000); lcd.begin(16, 
2); lcd.setCursor(0, 0); 
lcd.print("TANK LVL: "); 
lcd.setCursor(0, 1); 
...
Serial.println("kk"); lcd.setCursor(0, 
1); 
...
digitalWrite(mot,LOW); delay(100); 
 } */ } 
...
delayMicroseconds(2); digitalWrite(trigPin1, 
